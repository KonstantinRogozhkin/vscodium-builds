...
function hintDidYouMean(...meant) {
  switch (meant.length) {
    case 1:
      return localize(1830, null, meant[0]);
    case 2:
      return localize(1831, null, meant[0], meant[1]);
    case 3:
      return localize(1832, null, meant[0], meant[1], meant[2]);
    default:
      return void 0;
  }
}
var hintDidYouForgetToOpenOrCloseQuote = localize(1833, null);
var hintDidYouForgetToEscapeSlash = localize(1834, null);
...
var errorEmptyString = localize(1810, null);
var hintEmptyString = localize(1811, null);
var errorNoInAfterNot = localize(1812, null);
var errorClosingParenthesis = localize(1813, null);
var errorUnexpectedToken = localize(1814, null);
var hintUnexpectedToken = localize(1815, null);
var errorUnexpectedEOF = localize(1816, null);
var hintUnexpectedEOF = localize(1817, null);
var Parser = class _Parser {
  ...
  _errExpectedButGot(expected, got, additionalInfo) {
    const message = localize(1818, null, expected, Scanner.getLexeme(got));
...
var TerminalProcess = class TerminalProcess2 extends Disposable {
  ...
  async _validateCwd() {
    try {
      ...
      if (!result.isDirectory()) {
        return { message: localize(2312, null, this._initialCwd.toString()) };
      }
    } catch (err) {
      if (err?.code === "ENOENT") {
        return { message: localize(2313, null, this._initialCwd.toString()) };
      }
    }
  ...
  async _validateExecutable() {
    ...
    if (!executable) {
      return { message: localize(2314, null, slc.executable) };
    }
    try {
      const result = await fs2.promises.stat(executable);
      if (!result.isFile() && !result.isSymbolicLink()) {
        return { message: localize(2315, null, slc.executable) };
      }
  ...
  _doHandleVSCodeSequence(data) {
    ...
    switch (command) {
      ...
      case "EnvJson": {
        ...
        if (arg0 !== void 0) {
          try {
            const env2 = JSON.parse(deserializeMessage(arg0));
      ...
      case "EnvSingleDelete": {
        ...
        if (arg0 !== void 0 && arg1 !== void 0) {
          const env2 = deserializeMessage(arg1);
...
var PtyService = class extends Disposable {
  ...
  async _reviveTerminalProcess(workspaceId, terminal) {
    const restoreMessage = localize(2311, null);
...
async function startPtyHost() {
  ...
  const logger = loggerService.createLogger("ptyhost", { name: localize(2310, null) });
